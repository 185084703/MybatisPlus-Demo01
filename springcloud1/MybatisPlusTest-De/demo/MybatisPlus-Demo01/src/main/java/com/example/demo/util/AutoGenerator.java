...
public class AutoGenerator {
    ...
    public static void main(String[] args) {
        //1、配置数据源
        FastAutoGenerator.create("jdbc:mysql://127.0.0.1:3306/myapp?serverTimezone=UTC&useSSL=false&useUnicode=true&characterEncoding=utf-8&allowMultiQueries=true&autoReconnect=true&failOverReadOnly=false&maxReconnects=10", "root", "123456")
                //2、全局配置
                .globalConfig(builder -> {
                    builder.author("小康") // 设置作者名
                ...
                .strategyConfig(builder -> {
                    builder.addInclude("employees", "") // 设置需要生成的数据表名
